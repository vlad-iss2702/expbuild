...
/*Функция для переноса всех файлов и папок из папки fancybox*/
function fancybox(){
...
let build = gulp.series(clear, 
	gulp.parallel(styles, img, fancybox, fonts, owl, modal, scroll, js, html,)//В данном случае параллельно выполнятся всё что описано в скобках при вызове gulp build
);
